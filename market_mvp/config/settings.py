...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@market.local')

PAYMENT_VERIFY_ENABLED = config('PAYMENT_VERIFY_ENABLED', default=True, cast=bool)
PAYMENT_CLICK_SECRET = config('PAYMENT_CLICK_SECRET', default='')
PAYMENT_PAYME_SECRET = config('PAYMENT_PAYME_SECRET', default='')
PAYMENT_UZUM_SECRET = config('PAYMENT_UZUM_SECRET', default='')
